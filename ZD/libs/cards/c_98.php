...
/* terminada em 11/09/2016. terminada em 1 dia
 * Aumenta o ATK e DEF de um monstro Tipo SpellCaster equipado com esta carta em 300 pontos.
 */

class c_98 extends Magica {
 ...
 function ativar_efeito() {
  ...
  if(parent::ler_variavel('equipado_em') != 0) {return false;}
   ...
   for($x = 1; $x <= 5; $x++) {
    ...
    if(!$lista) {
        parent::avisar('Não foram encontrados monstros tipo SpellCaster em no seu campo');
        parent::destruir();
        return false;
    }
