 ...
 * Quando essa carta é Normal Summon: Você pode Special Summon 1 monstro (Constellar) de nível 5 da sua mão,
 * este virado para cima.
 */
class c_138 extends Monstro_normal {
 ...
 private function _ativar() {  // Efeito desse monstro
    ...
    for($x = 1; $x < $mao[0]; $x++) {
        $carta->ler_id($mao[$x]);
        if($this->isConstellar($mao[$x]) && $carta->lv == 5) { // id de um monstro constellar
