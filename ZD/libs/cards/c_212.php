...
/* terminada em 04/05/2017. terminada em 1 dia
 * Aumenta o ATK e DEF de um monstro Dragon equipado com esta carta em 300 pontos
 */

class c_212 extends Magica {
 ...
 function ativar_efeito() {
  ...
  if(parent::ler_variavel('equipado_em') != 0) {return false;}
   ...
   for($x = 1; $x <= 5; $x++) {
    ...
    if(!$lista) {
        parent::avisar('Não foram encontrados monstros tipo dragão em no seu campo');
        parent::destruir();
        return false;
    }
