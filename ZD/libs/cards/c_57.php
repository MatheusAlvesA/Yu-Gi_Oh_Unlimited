...
/* modificado dia 11/09/2016 modificado em 1 dia
 * Aumente o ATK e DEF de um monstro Beast equipado com esta carta em 300 pontos.
 */

class c_57 extends Magica {
 ...
 function ativar_efeito() {
  ...
  if(parent::ler_variavel('equipado_em') != 0) {return false;}
   ...
   for($x = 1; $x <= 5; $x++) {
    ...
    if(!$lista) {
        parent::avisar('Não foram encontrados monstros tipo Beast em no seu campo');
        parent::destruir();
        return false;
    }
