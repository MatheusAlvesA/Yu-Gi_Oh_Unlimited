...
/* carta terminada dia 29/09/2016. terminada em 2 dias
 * Quando essa carta é Normal Summon: Você pode Special Summon 1 monstro (Constellar) de level 3 da sua mão.
 */
class c_125 extends Monstro_normal {
 ...
 private function _ativar() {  // Efeito desse monstro
    ...
    for($x = 1; $x < $mao[0]; $x++) {
        $carta->ler_id($mao[$x]);
        if($this->isConstellar($mao[$x]) && $carta->lv == 3) { // id de um monstro constellar
