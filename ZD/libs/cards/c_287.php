<?php
class c_287 extends Magica {
    // carta terminada dia 08/06/2017. terminada em 1 dia
    /*Aumente o ATK de todos os monstros EARTH em 500 pontos e diminuir a sua DEF em 400 pontos.*/
 ...
 private function checar_atrib($carta) {
     if($carta->atributo == 'earth') return true;
     return false;
 }
