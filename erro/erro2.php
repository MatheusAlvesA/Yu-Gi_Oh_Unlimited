...
if($x == 1) {header("location: erro1.php");exit();}
session_start();
session_destroy();
?>
<!DOCTYPE html>
<html lang="pt">
  <head> <?php include '../head.txt';?>
    ...
    <title>Manutenção Yu-Gi-Oh Unlimited</title>
...
<div role="main" class="col-md-8 col-md-push-2">
	<h1 style="text-align: center;">Em manutenção</h1><hr>
	<h2>O site está passando por uma manutenção temporária.</h2>
